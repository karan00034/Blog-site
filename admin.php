...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <tr>
        ...
        <td><?php echo $time; ?></td>
        <td><a href="edit.php?id=<?php echo $id; ?>" class="btn btn-primary">Edit</a>  <a href="del.php?id=<?php echo $id; ?>"
                                                                   onclick="return confirm('Are you sure you want to delete this post?')" class="btn btn-danger">Delete</a>
        </td>
    </tr>
